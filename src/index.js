...
module.exports = function toReadable (number) {
  ...
  let secondNum = Math.floor(number/10);
  ...
  if (number == 0) {result = "zero";}
    ...
    secondNum = Math.floor((number-(hundreds*100))/10);
    if (secondNum !== 1 && lastNum == 0) {
    result = numbers[hundreds -1] + ' hundred ' + tens[secondNum - 1];}
    else if (secondNum == 1 && lastNum !== 0) {
